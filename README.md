...
- Ödeme akışı demodur; kart bilgisi hiçbir yere gönderilmez.
- TR / EN dil değiştirici `data-en` öznitelikleriyle çalışır.

GitHub Pages ile `main` dalının kökünden yayınlanır.
